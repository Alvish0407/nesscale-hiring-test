                    ...
                    if (controller.isOTPSent.value) ...[
                      ...
                      PinCodeTextField(
                        ...
                        pinTheme: PinTheme(
                          ...
                          inactiveColor: hoverColor.withOpacity(.5),
                          errorBorderColor: redColor,
                          selectedColor: lPrimaryTextColor,
                          borderWidth: 1,
                          shape: PinCodeFieldShape.box,
                          borderRadius: BorderRadius.circular(5),
                          fieldHeight: 50,
                          fieldWidth: 50,
                          activeFillColor: lPrimaryTextColor,
                          inactiveFillColor: lPrimaryTextColor,
                          selectedFillColor: lPrimaryTextColor,
                        ),
