import 'package:alvish_nesscale_assignment/design/components/measure_size.dart';
        ...
        Obx(
          () => Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: pureWhiteColor.withOpacity(.33)),
            ),
          ),
        ),
        Expanded(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                hintStyle: TextThemeX.text14.copyWith(
                  ...
                  color: lPrimaryTextColor.withOpacity(.3),
                ),
                filled: true,
                ...
                focusedBorder: OutlineInputBorder(
                  ...
                  borderSide: BorderSide(
                    width: 1,
                    color: lPrimaryColor.withOpacity(.67),
                  ),
                ),
